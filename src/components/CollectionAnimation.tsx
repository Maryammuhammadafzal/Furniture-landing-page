     ...
     <div className="relative w-full min-h-[3000px] flex flex-col gap-40 justify-start items-center">
          <div style={{
            ...
            <h2
              style={{
                transform: `${
                  offset > 600 && offset < 700 && `translateX(-${350}px) translateY(50px)`
                }`,
                transition: "transform 0.3s linear",
              }}
          ...
          >
            <div
              style={{
                transform: `${
                  ...
                  `translateX(-${350}px) translateY(-${100}px)`
                }`,
                transition: "transform 0.3s linear", 
              }}
            ...
            <h2  style={{
                transform: `${
                  offset > 900 && offset < 1000 &&
                  `translateX(${500}px) translateY(50px)`
                }`,
                transition: "transform 0.3s linear", 
            ...
            <h2 
             style={{
                transform: `${
                  ...
                  `translateX(-${350}px) translateY(50px)`
                }`,
                transition: "transform 0.3s linear", 
              }} className="card-heading max-w-lg leading-16 font-mono md:text-6xl sm:text-5xl text-4xl text-primary ">
          ...
          >
            ...
            style={{
                transform: `${
                  ...
                  `translateX(-${350}px) translateY(-100px)`
                }`,
                transition: "transform 0.3s linear", 
              }} className="slider-image w-[390px] h-[435px] flex justify-center items-center -rotate-6">
              <Image
          ...
          >
            ...
            <h2 style={{
                transform: `${
                  offset > 3000 && offset < 3100 &&
                  `translateX(${500}px) translateY(100px)`
                }`,
                transition: "transform 0.3s linear", 
              }} className="card-heading max-w-lg leading-16 font-mono md:text-6xl sm:text-5xl text-4xl text-primary ">
              Custom Furniture
